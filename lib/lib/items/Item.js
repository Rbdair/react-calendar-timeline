      ...
      (0, _interactjs2.default)(this.item).resizable({
        ...
        if (_this2.state.dragging) {
          ...
          if (_this2.props.moveResizeValidator) {
            var validResult = _this2.props.moveResizeValidator('move', _this2.props.item, dragTime, undefined, _this2.props.order.index + dragGroupDelta, _this2.props.order.index);
            ...
            if (validResult.newGroupIndex) {
              dragGroupDelta = validResult.newGroupIndex - _this2.props.order.index;
            }
          }

          if (_this2.props.onDrag) {
            _this2.props.onDrag(_this2.itemId, dragTime, _this2.props.order.index + dragGroupDelta, _this2.props.item);
          }
        ...
        if (_this2.state.dragging) {
          if (_this2.props.onDrop) {
            ...
            _this2.props.onDrop(_this2.itemId, dragTime, _this2.props.order.index + dragGroupDelta, _this2.props.order.index, _this2.props.item);
          }
        ...
        if (_this2.state.resizing) {
          ...
          if (_this2.props.moveResizeValidator) {
            var validResult = _this2.props.moveResizeValidator('resize', _this2.props.item, resizeTime, resizeEdge, _this2.props.order.index + _this2.dragGroupDelta(e), _this2.props.order.index);
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.handleDoubleClick = function (e) {
    ...
    if (_this3.props.onItemDoubleClick) {
      _this3.props.onItemDoubleClick(_this3.itemId, e, _this3.props.item);
    }
  };
  ...
  this.handleContextMenu = function (e) {
    if (_this3.props.onContextMenu) {
      e.preventDefault();
      e.stopPropagation();
      _this3.props.onContextMenu(_this3.itemId, e, _this3.props.item);
    }
  };
